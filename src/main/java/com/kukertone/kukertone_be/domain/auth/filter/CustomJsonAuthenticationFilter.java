package com.kukertone.kukertone_be.domain.auth.filter;
...
public class CustomJsonAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String USERNAME_KEY = "email"; // 회원 로그인 시 아이디 요청 JSON Key : "email"
    private static final String PASSWORD_KEY = "password"; // 회원 로그인 시 비밀번호 요청 JSon Key : "password"
    private static final String ROLE_KEY = "roles"; // 회원 로그인 시 비밀번호 요청 JSon Key : "role"
