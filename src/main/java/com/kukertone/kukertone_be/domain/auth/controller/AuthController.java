package com.kukertone.kukertone_be.domain.auth.controller;
...
import com.kukertone.kukertone_be.common.dto.ResponseDto;
import com.kukertone.kukertone_be.domain.auth.dto.request.JoinRequestDto;
import com.kukertone.kukertone_be.domain.auth.service.AuthService;
...
public class AuthController {
    ...
    @PostMapping("/join")
    public ResponseEntity<Void> join(@RequestBody JoinRequestDto signUpRequestDto) {
