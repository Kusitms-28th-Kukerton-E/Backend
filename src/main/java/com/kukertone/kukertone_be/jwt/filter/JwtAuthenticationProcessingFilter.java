package com.kukertone.kukertone_be.jwt.filter;
...
import com.kukertone.kukertone_be.util.PasswordUtil;
...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
     ...
     */
    private void reIssueAccessToken(HttpServletResponse response, String refreshToken, String email, String role) {
        String newAccessToken = jwtService.createAccessToken(email, role);
